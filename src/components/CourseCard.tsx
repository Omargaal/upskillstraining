...
export function CourseCard({ course }: { course: Course }) {
  return (
    <article className="group flex flex-col rounded-2xl border bg-card p-6 shadow-card transition hover:-translate-y-1 hover:shadow-elevated">
      ...
      <h3 className="mt-4 font-display text-xl font-bold text-foreground min-h-[3.5rem]">
        {course.title}
      </h3>
